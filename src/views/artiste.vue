<template>
  <div class=" pb-32">
    ...
    <div class="flex flex-wrap mx-3 justify-center gap-4">
      ...
      <!-- artiste / engelwood -->
      <div class="flex flex-col ">
        <h3 class="font-mulish font-bold text-white text-[22px] shadow_text text-center">EngelWood</h3>
        <img src="public\artiste\engelwood.png" alt="vantage" class="box-shadow">
        <div class="flex justify-center">
          <img src="public\icon\plus.svg" alt="plus" class="w-10 mt-[-20px] box-shadow2">
        </div>
      </div>
      ...
      <div class="flex flex-col ">
        ...
        <img src="public\artiste\nighttempo.png" alt="vantage" class="box-shadow">
        <div class="flex justify-center">
          <img src="public\icon\plus.svg" alt="plus" class="w-10 mt-[-20px] box-shadow2">
        </div>
      </div>
      <!-- artiste / engelwood -->
      <div class="flex flex-col ">
        <h3 class="font-mulish font-bold text-white text-[22px] shadow_text text-center">MACROSS</h3>
        <img src="public\artiste\macross.png" alt="vantage" class="box-shadow">
        <div class="flex justify-center">
          <img src="public\icon\plus.svg" alt="plus" class="w-10 mt-[-20px] box-shadow2">
        </div>
      </div>
      ...
      <div class="flex flex-col ">
        ...
        <img src="public\artiste\yungbae.png" alt="vantage" class="box-shadow">
        <div class="flex justify-center">
          <img src="public\icon\plus.svg" alt="plus" class="w-10 mt-[-20px] box-shadow2">
        </div>
      </div>
      <!-- artiste / meoshop -->
      <div class="flex flex-col ">
        <h3 class="font-mulish font-bold text-white text-[22px] shadow_text text-center">Moe Shop</h3>
        <img src="public\artiste\moeshop.png" alt="vantage" class="box-shadow">
        <div class="flex justify-center">
          <img src="public\icon\plus.svg" alt="plus" class="w-10 mt-[-20px] box-shadow2">
        </div>
      </div>
      ...
      <div class="flex flex-col ">
        ...
        <img src="public\artiste\desired.png" alt="vantage" class="box-shadow">
        <div class="flex justify-center">
          <img src="public\icon\plus.svg" alt="plus" class="w-10 mt-[-20px] box-shadow2">
        </div>
      </div>
